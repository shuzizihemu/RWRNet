...
class PatchMerging(nn.Layer):
    ...
    def forward(self, x):
        ...
        # self.input_resolution = x.shape[-2:]
...
#     tmp = paddle.to_tensor(np.random.rand(2, 48, 224, 224), dtype='float32')
#     print(tmp.shape)
#     sts = SwinT(in_channels=48, out_channels=48, input_resolution=(224, 224), num_heads=8, window_size=8, qkv_bias=False, qk_scale=None, dropout=0.1, attention_dropout=0.1, droppath=0.1, downsample=False)
#     out = sts(tmp)
#     print(out.shape)
